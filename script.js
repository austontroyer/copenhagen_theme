document.addEventListener("DOMContentLoaded", function () {
  ...
  var contactUsChat = document.querySelector(
    "#main-content > footer > div.article-more-questions > p > a"
  );

  if (contactUsChat) {
    contactUsChat.addEventListener("click", function () {
      zE.activate();
    });
  }

  // Change recently viewed articles

  var recentlyViewedContent = document.querySelector(
    "#main-content > div > section.recent-articles > h2"
  );
  ...
  var relatedArticles = document.querySelector(
    "#main-content > div > section.related-articles > h2"
  );
